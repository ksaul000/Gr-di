...
export class NivelToamna1Component implements OnInit {
  ...
  emote_image: string = "../../assets/nivel_toamna1/serioasa.png";
  audio = new Audio;
  ...
  clickOnCorrectButton1(): void{
    if(this.correct_answer_button1_visible){
      ...
      this.emote_image = "../../assets/nivel_toamna1/fericita.png";
  ...
  clickOnWrongButton(): void{
    this.emote_image = "../../assets/nivel_toamna1/trista.png"
